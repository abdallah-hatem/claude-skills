...
**Add the house lint config** if an app lacks it — its own `chore/lint` commit, existing violations
frozen with `eslint --suppress-all` ([building-frontends/lint.md](../building-frontends/lint.md),
